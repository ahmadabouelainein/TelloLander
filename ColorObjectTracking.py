...
cv2.createTrackbar("HUE Max", "HSV", 93, 179, empty)
cv2.createTrackbar("SAT Min", "HSV", 40, 255, empty)
cv2.createTrackbar("SAT Max", "HSV", 100, 255, empty)
cv2.createTrackbar("VALUE Min", "HSV", 95, 255, empty)
cv2.createTrackbar("VALUE Max", "HSV", 200, 255, empty)
